...
class Logs(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    temps = db.Column(db.String(200), nullable=False)
    nom_machine = db.Column(db.String(200), nullable=False)
    oid_value = db.Column(db.String(200), nullable=False)
    val_text = db.Column(db.String(200), nullable=False)
    val_num = db.Column(db.BigInteger, nullable=False)
...
@app.route('/logs_machine', methods=['GET', 'POST'])
def logs_machine():
    logs = []
