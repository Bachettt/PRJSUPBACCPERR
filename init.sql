...
VALUES ('DOCKER_LIN', '10.0.0.4', 'Machine contenant docker', '5'), ('Windows-Client-Serv', '10.0.0.5', 'Machine windows', '5'), ('MACHINE-SCRIPT-CLIENT', '10.0.0.6', 'Machine qui lance les scripts snmp','5');
